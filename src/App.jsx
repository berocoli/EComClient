      ...
      <nav className="flex fixed justify-between items-center top-0 left-0 w-full bg-slate-600 text-white p-4 shadow z-50">
        ...
        {isLoggedIn && (
          <div className="flex items-center space-x-4">
            <span className="flex items-center space-x-2 bg-blue-500 hover:bg-blue-700 px-3 py-2 rounded-lg cursor-pointer">
              <FaUserCircle size={24} />
              <span>Logged In</span>
            </span>
            <button onClick={handleLogout} className="flex items-center space-x-2 bg-red-500 hover:bg-red-700 px-3 py-2 rounded-lg">
